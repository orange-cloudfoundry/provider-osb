...
func NewOsbClient(conf v1alpha1.ProviderConfig, creds []byte) (osbClient.Client, error) {
...
func Connect(
	...
	newOsbClient func(v1alpha1.ProviderConfig, []byte) (osbClient.Client, error),
	mg resource.Managed,
	oidValue common.KubernetesOSBOriginatingIdentityValue,
) (osbClient.Client, client.Client, *osbClient.OriginatingIdentity, error) {
