...
func (si *ServiceInstance) IsDeletable() bool {
	return meta.WasDeleted(si) &&
		si.Status.AtProvider.LastOperationState == osbClient.StateSucceeded &&
		!si.Status.AtProvider.HasActiveBindings
}

func (si *ServiceInstance) HasLastOperation() bool {
	return si.Status.AtProvider.LastOperationKey != ""
}
...
func (si *ServiceInstance) buildProvisionRequest(params map[string]any, ctxMap map[string]any, disableAsync bool) (*osbClient.ProvisionRequest, error) {
...
func (si *ServiceInstance) buildUpdateInstanceRequest(oid osbClient.OriginatingIdentity, disableAsync bool) (*osbClient.UpdateInstanceRequest, error) {
	params, err := si.Spec.ForProvider.Parameters.ToParameters()
	if err != nil {
...
func (si *ServiceInstance) buildDeprovisionRequest(oid osbClient.OriginatingIdentity, disableAsync bool) (*osbClient.DeprovisionRequest, error) {
	if si.Spec.ForProvider.InstanceId == "" {
...
func (si *ServiceInstance) Deprovision(ctx context.Context, kube client.Client, osb osbClient.Client, oid osbClient.OriginatingIdentity, disableAsync bool) error {
	...
	req, err := si.buildDeprovisionRequest(oid, disableAsync)
	if err != nil {
...
func (si *ServiceInstance) Provision(ctx context.Context, kube client.Client, osb osbClient.Client, disableAsync bool) error {
	params, err := si.Spec.ForProvider.Parameters.ToParameters()
	if err != nil {
	...
	req, err := si.buildProvisionRequest(params, ctxMap, disableAsync)
	if err != nil {
...
func (si *ServiceInstance) Update(ctx context.Context, kube client.Client, osb osbClient.Client, oid osbClient.OriginatingIdentity, disableAsync bool) error {
	// Build the OSB update request.
	req, err := si.buildUpdateInstanceRequest(oid, disableAsync)
	if err != nil {
...
func (si *ServiceInstance) ObserveState(
	...
	// Manage pending async operations
	if si.HasLastOperation() {
	...
	if meta.WasDeleted(si) {
		if err := si.HandleDeletionWithActiveBindings(ctx, kube); err != nil {
			return common.NeedToCreate, nil, fmt.Errorf("%w, %s", errFailedToHandleDeletionWithActiveBindings, fmt.Sprint(err))
		}
