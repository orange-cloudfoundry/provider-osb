...
func (sb *ServiceBinding) Bind(ctx context.Context, kube client.Client, osb osbClient.Client, oid osbClient.OriginatingIdentity, disableAsync bool) (*osbClient.BindResponse, bool, error) {
	...
	req, err := sb.buildBindRequest(oid, requestContext, requestParams, disableAsync)
	if err != nil {
...
func (sb *ServiceBinding) buildBindRequest(
	...
	bindRequest := osbClient.BindRequest{
		...
		OriginatingIdentity: &oid,
		InstanceID:          sb.Spec.ForProvider.InstanceId,
		AcceptsIncomplete:   !disableAsync, // async by default
...
func (sb *ServiceBinding) addBindResource(bindRequest *osbClient.BindRequest) {
	...
	bindResource.Route = &sb.Spec.ForProvider.BindResource.Route
